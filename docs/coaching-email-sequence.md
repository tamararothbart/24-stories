...
## EMAIL 1 — After story 3

**Trigger:** Storyteller submits their third story (PromptNumber reaches 3)
**To:** Storyteller
**From:** hello@24stories.co.za
**Purpose:** Check-in. Plant the seed gently. Single session as low-commitment entry point.

---

Subject A: How are the first three stories feeling?

Subject B: Three weeks in — a note from Tamara

Preview text: The first three stories are usually the hardest. I wanted to check in.
...
## EMAIL 2 — After story 8

**Trigger:** Storyteller submits their eighth story (PromptNumber reaches 8)
**To:** Storyteller
**From:** hello@24stories.co.za
**Purpose:** Upsell to a bundle. Frame coaching as going deeper, not rescue.

---

Subject A: Eight stories. Something has changed.

Subject B: For those who want to go further

Preview text: Eight stories in. You're past the uncertain part. There's more available.
...
## EMAIL 3 — After story 15

**Trigger:** Storyteller submits their fifteenth story (PromptNumber reaches 15)
**To:** Storyteller
**From:** hello@24stories.co.za
**Purpose:** Reach the storyteller who has been avoiding something difficult. Six-session bundle.

---

Subject A: Some of the most important ones may still be ahead

Subject B: The stories you've been putting off

Preview text: Fifteen stories done. The harder ones may still be ahead — and I'm here.

---

Hello [StorytellerFirstName],

Fifteen stories. You are well past the halfway point.
...
## EMAIL 4 — Week 24 prompt sent

**Trigger:** Week 24 prompt dispatched (PromptNumber reaches 24)
**To:** Storyteller
**From:** hello@24stories.co.za
**Purpose:** Referral. Plant the next subscriber. Do not push coaching.

---

Subject A: Twenty-four stories — a quiet note from me

Subject B: You've done something most people never do

Preview text: Twenty-four stories written. That's more than most people manage in a lifetime.
