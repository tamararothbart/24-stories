...
exports.handler = async (event) => {
  ...
  <div style="font-family:Georgia,serif;max-width:580px;margin:0 auto;background:#F7F5F2;padding:0;">
    ...
    <div style="background:#C0392B;padding:20px 32px;">
      <p style="font-family:Arial,sans-serif;font-size:11px;letter-spacing:0.18em;text-transform:uppercase;color:rgba(255,255,255,0.7);margin:0 0 6px;">24 Stories — Referral</p>
      <p style="font-family:Georgia,serif;font-size:22px;font-weight:bold;color:#ffffff;margin:0;line-height:1.2;">New referral received<br>— follow up ASAP</p>
    </div>

    <div style="padding:32px 32px 28px;">
      <p style="font-family:Georgia,serif;font-size:15px;color:#555;line-height:1.7;margin:0 0 24px;">A subscriber has recommended someone whose stories should be told.</p>
    ...
    <div style="border-top:1px solid #E0DDD8;padding:16px 32px 24px;">
      <p style="font-family:Arial,sans-serif;font-size:12px;color:#aaa;line-height:1.6;margin:0;">Lead saved to Airtable &rarr; 24stories-live &rarr; Coaching &middot; Method: Referral</p>
    </div>
