...
async function sendEmail(mjAuth, { to, subject, html }) {
  const res = await fetch('https://api.mailjet.com/v3.1/send', {
    ...
    body: JSON.stringify({
      Messages: [{ From: { Email: 'stories@24stories.co.za', Name: '24 Stories' }, ReplyTo: { Email: 'hello@24stories.co.za', Name: 'Tamara Rothbart' }, To: [to], Subject: subject, HTMLPart: html }]
    })
  });
...
<div style="background:#F7F5F2;padding:48px 40px;color:#1A1A1A;">
  ...
  <div style="border-top:3px solid #B8976A;padding:28px 0 24px;margin:40px 0 32px;">
    ...
    <p style="font-size:14px;color:#555;line-height:1.7;margin:12px 0 0;">Missed a prompt? Return to your Story Library at any time to record it.</p>
